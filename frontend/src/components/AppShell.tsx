    ...
    <div className="app-shell">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavItem to="/jobs" icon="◫" label="Job Positions" />
          <NavItem to="/candidates" icon="◻" label="Candidates" />
          <NavItem to="/schedule" icon="⊕" label="Schedule Interview" />
        ...
        <div className="sidebar-bottom">
          <div className="sidebar-user" onClick={handleLogout} title="Click to sign out">
            ...
            <div className="user-info">
              <div className="user-name">{hr?.name}</div>
